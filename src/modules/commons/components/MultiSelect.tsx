      ...
      <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border h-10 items-center justify-between bg-inherit hover:bg-inherit",
              className,
            )}
          >
                  ...
                  {selectedValues.slice(0, maxCount).map(value => {
                    ...
                    return (
                      <Badge
                        key={value}
                        className={cn(
                          "!bg-[hsla(28,62%,96%,1)] !border-none !text-primary",
            ...
            <CommandList>
              ...
              <CommandGroup>
                ...
                >
                  <div
                    className={cn(
                      "mr-2 flex items-center justify-center rounded-sm ",
