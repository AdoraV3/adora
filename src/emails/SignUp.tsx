      ...
      >
        <Body className="bg-white-100 w-full">
          <Container className="py-4">
            ...
            <Heading className="font-medium text-[#575757] text-2xl py-3 font-satoshi">
              Verify this email address to complete sign up{" "}
            </Heading>
            <Text className="text-[#575757] font-satoshi text-lg font-semibold pb-3">
              Hi {name},
            </Text>
            ...
            <Text className="text-[#575757] font-satoshi font-normal pb-3 text-lg">
            ...
            <Text className="text-[#575757] font-satoshi font-semibold text-lg pb-2">
              Uche Igbonachor
            </Text>
            <Text className="text-[#575757] font-satoshi font-normal pb-3 text-lg">
              CEO, Adora Inc.
            ...
            <Text className="text-base pb-2 font-medium text-[#575757] font-satoshi">
              Ontario. Canada L5R 0B6
            </Text>

            <Text className="font-satoshi font-normal text-base text-[#575757]">
              {" "}
